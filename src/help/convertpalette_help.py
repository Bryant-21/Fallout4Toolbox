...
class PaletteConvertHelp(ScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.info = TextCard(
            text=
            """            
            So you already have a palette, and want to convert texture to black and white so they use that palette. 
            
            That is what this does. That's it. You can do something similar in the palette generator, but this is good for adding textures after the fact.
            """,
            height=300
        )
