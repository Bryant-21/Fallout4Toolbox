...
class TemplateHelp(ScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.info = TextCard(
            ...
            This allows you to take an already created mod and renames all EDIDs with your new mod name.
            
            So I have included the template esp I use for guns. It will replace all records with B21_Template_Gun_* with my mod names
            
            Example B21_Template_Gun_Barrel_1 -> B21_NewGun_Barrel_1
