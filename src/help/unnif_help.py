...
class NifUVHelp(ScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.info = TextCard(
            ...
            Uses pynifly to get the UVW coordinates from Nif files, and then remove all of the "filler" inbetween the islands.
            
            Why? IDK seemed like something fun to try.
            
            Also added in MIP flooding and Infinite Dilation. 
            
            Needs a "root" directory. Can me your mod location or your unpacked game folder.
