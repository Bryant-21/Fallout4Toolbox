...
class QuantizeHelp(ScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.info = TextCard(
            ...
            Test the different quantizers before making a palette.
            
            Advanced Quantize will reduce it down to 2x the limit and then use LAB color spaces to reduce similar colors. Useful to keep small color details.
