...
class MatfilesHelp(ScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.info = TextCard(
            text=
            """
            I use this to copy my materials files into sub folders without having to manually edit each one.
            
            So just select your base dir, and then the subfolders you want it to make
            
            It will automatically edit the selected paths of the materials files and put them in the right folders.
