...
class BulkPaletteHelp(ScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.info = TextCard(
            text=
            """
            Kinda like the regular palette but will do it for a whole folder. Basically, it will take all the "parts" / textures and try and map all the most common colors to a palette.
