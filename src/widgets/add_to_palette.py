...
class AddToPaletteWidget(BaseWidget):
    ...
    def __init__(self, parent: Optional[QWidget], text: str = "Add To Palette"):
        ...
        self.npz_card = PushSettingCard(
            ...
            CustomIcons.SELECTION.icon(),
            self.tr("Select the palette segments NPZ generated by the Palette Generator"),
        ...
        self.texture_card = PushSettingCard(
            self.tr("New Color Texture"),
            CustomIcons.IMAGE.icon(stroke=True),
            self.tr("Select the new color texture that matches the greyscale layout"),
        ...
        self.filter_edit_card = TextSettingCard(
            ...
            FIF.FILTER,
            self.tr("Target Filename(s)"),
            self.tr("Filename filter (optional, supports * and ?): What files do you want to match on?")
        )
